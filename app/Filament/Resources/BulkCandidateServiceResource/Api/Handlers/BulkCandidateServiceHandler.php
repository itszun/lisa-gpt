<?php
namespace App\Filament\Resources\BulkCandidateServiceResource\Api\Handlers;
...
class BulkCandidateServiceHandler extends Handlers {
    public static string | null $uri = '/candidates/bulk-create';
    public static string $method = 'POST';
    // public static string | null $resource = BulkCandidateServiceResource::class;
