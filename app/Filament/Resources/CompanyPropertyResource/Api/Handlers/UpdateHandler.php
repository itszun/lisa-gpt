...
use App\Filament\Resources\CompanyPropertyResource\Api\Requests\UpdateCompanyPropertyRequest;
...
class UpdateHandler extends Handlers {
     ...
     *
     * @param UpdateCompanyPropertyRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateCompanyPropertyRequest $request)
    {
        $id = $request->route('id');
