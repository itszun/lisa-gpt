...
<head>
    ...
    <title>LISA - AI Chatbot untuk HR</title>
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
							<a href="#">
								<img class="header-logo-image" src={{asset("templates/dist/images/logo.svg")}} alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
					...
					<div class="features-inner section-inner has-bottom-divider">
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src={{asset("templates/dist/images/feature-icon-01.svg")}} alt="Feature 01">
                                    </div>
                                    <h4 class="feature-title mt-24">Automasi scouting talent</h4>
							...
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src={{asset("templates/dist/images/feature-icon-02.svg")}} alt="Feature 02">
                                    </div>
                                    <h4 class="feature-title mt-24">Analisis kandidat</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src={{asset("templates/dist/images/feature-icon-03.svg")}} alt="Feature 03">
                                    </div>
                                    <h4 class="feature-title mt-24">Dukungan 24/7</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src={{asset("templates/dist/images/feature-icon-04.svg")}} alt="Feature 04">
                                    </div>
                                    <h4 class="feature-title mt-24">Lebih Produkti</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src={{asset("templates/dist/images/feature-icon-05.svg")}} alt="Feature 05">
                                    </div>
                                    <h4 class="feature-title mt-24">Interaksi Natural</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
										<img src={{asset("templates/dist/images/feature-icon-06.svg")}} alt="Feature 06">
                                    </div>
                                    <h4 class="feature-title mt-24">User Friendly</h4>
                                    <p class="text-sm mb-0">Fermentum posuere urna nec tincidunt praesent semper feugiat nibh. A arcu cursus vitae congue mauris. Nam at lectus urna duis convallis. Mauris rhoncus aenean vel elit scelerisque mauris.</p>
                                </div>
                            </div>
                        </div>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner">
                    ...
                    <div class="footer-copyright">&copy; 2025 Alta Teknologi Indonesia, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>

    <script src={{asset("templates/dist/js/main.min.js")}}></script>
</body>
</html>
